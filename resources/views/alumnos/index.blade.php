                                    ...
                                    <tr style="font-size: 18px;">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="d-flex justify-content-center ">
                                                @can('editar-alumno')
                                                <div class="mx-1">
                                                <a class="btn btn-info textoGBB" style="background-color: #40cdf3; border-color: #40cdf3;" href="{{ route('alumnos.edit', $alumno->id) }}"><span class="d-md-inline d-none">Editar</span><i class="fas fa-edit"></i></a>
                                                </div>
                                                @endcan
