...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Asignar Materias</h3>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! Form::open(array('route' => 'asignarGrupos.store','method'=>'POST', 'id' => 'crearRolForm')) !!}
                            <div class="row">
                            <div class="col-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <label for="" style="font-size:20px;">Materias para este grupo:</label><!--span class="required text-danger">*</span-->
                                        </div>
                                    </div>                                    
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr class="textoG text-secondary" style="background-color: #8C438B;">
                                                        <th class="text-center text-white font-weight-bold">Materias</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                ...
                                                <tr id="fila_permiso_{{ $value->id }}">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-6 text-center">
                                                            <button type="button" class="btn btn-sm btn-primary" onclick="seleccionarPermiso({{ $value->id }}, '{{ $value->nombre }}')">
