                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label for="semestre"><span class="textoG">Semestre:</span></label><!--span class="required text-danger">*</span-->
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::number('creditos', null, array('class' => 'form-control', 'style'=>'font-size:16px;')) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
