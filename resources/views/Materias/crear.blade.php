                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <label for="clave_curso"><span class="textoG">Clave de curso:</span></label>
                                        {!! Form::text('clave_curso', null, array('class' => 'form-control', 'style'=>'font-size:16px;')) !!}
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <label for="nombre"><span class="textoG">Nombre de la materia:</span></label>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <label for="creditos"><span class="textoG">Créditos:</span></label>
